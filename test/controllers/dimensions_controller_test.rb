...
class DimensionsControllerTest < ActionController::TestCase
  ...
  test "should create dimension" do
    assert_difference('Dimension.count') do
      post :create, dimension: { description: @dimension.description, id_task: @dimension.id_task, name: @dimension.name }
    end
  ...
  test "should update dimension" do
    patch :update, id: @dimension, dimension: { description: @dimension.description, id_task: @dimension.id_task, name: @dimension.name }
    assert_redirected_to dimension_path(assigns(:dimension))
  end
